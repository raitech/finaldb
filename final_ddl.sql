...
--VIEW DO EXERCICIO 4 - ISADORA
CREATE OR REPLACE VIEW v_requisitos AS
  SELECT SIGLA, DISCIPLINA, SIGLAREQ, DD.NOMEDISC AS REQUISITO FROM
    (SELECT D.SIGLADISC AS SIGLA, D.NOMEDISC AS DISCIPLINA, P.SIGLAREQ AS SIGLAREQ
      FROM L07_DISCIPLINA D LEFT JOIN L08_PREREQUISITO P ON D.SIGLADISC=P.SIGLADISC
